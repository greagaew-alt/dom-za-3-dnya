...
def page_index():
  ...
  %s""" % grid(3, [
        ...
        card("Гарантия 5 лет",
             "Гарантия прописывается в договоре и распространяется на "
             "конструктив дома, кровлю и качество выполненных работ."),
        card("Все документы остаются у вас",
             "Получаете договор, смету, акт приёмки и гарантийный талон."),
