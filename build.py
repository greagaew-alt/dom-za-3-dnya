...
def page_index():
  ...
  %s""" % grid(3, [
        ...
        card("Работаем официально, как ИП",
             "Все расчёты и обязательства зафиксированы по закону &mdash; "
             "никаких серых схем. Договор, смета и акт приёмки на руках."),
