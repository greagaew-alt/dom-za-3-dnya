...
KOMPL = [
    ...
    ("Высота потолка 1 этажа", "2300 мм", "от 2450 мм", "от 2450 мм"),
    ("Высота потолка 2 этажа", "от 2150 мм", "2300 мм", "от 2300 мм"),
...
<footer>
  <div class="foot-in">
    <div>
      ...
      <span style="color:#999">13 лет на рынке &middot; 2000+ построенных объектов</span>
    </div>
    <div>
      <b>Разделы</b>
      %s
...
def page_index():
  ...
  <div class="split">
    ...
    <div>%s</div>
        ...
        chips("13 лет на рынке", "2000+ домов построено",
  ...
  %s""" % grid(3, [
        ...
        card("13 лет работы",
             "Работаем с 2013 года и построили более 2000 домов."),
  ...
  <div class="quiz">
    <div class="qstep"><div class="qnum">Шаг 1 из 5</div>
      ...
      <div class="opts"><span class="opt">Сезонное проживание</span>
      <span class="opt">Для зимнего отдыха</span>
    ...
    <div class="qstep"><div class="qnum">Шаг 2 из 5</div>
      ...
      <span class="opt">Двухэтажный</span><span class="opt">Пока не решил</span></div></div>
    <div class="qstep"><div class="qnum">Шаг 3 из 5</div>
      <div class="qq">Какой размер планируете?</div>
      <div class="opts"><span class="opt">6&times;4 и меньше</span><span class="opt">5&times;6</span>
      <span class="opt">6&times;6</span><span class="opt">6&times;7</span>
      <span class="opt">6&times;8</span><span class="opt">6&times;9 и больше</span>
      <span class="opt">Другой размер</span></div></div>
    <div class="qstep"><div class="qnum">Шаг 4 из 5</div>
      <div class="qq">Нужен ли фундамент?</div>
      <div class="opts"><span class="opt">Нужен</span>
      <span class="opt">Уже есть</span></div></div>
  ...
  <div class="btns">%s%s</div>""" % (
        grid(2, [
            ...
            click("Клик &middot; каталог",
                  "Двухэтажные",
                  "<span class='price'>от "
                  + r(type_min("Двухэтажные")) + "</span>",
                  href="catalog.html#dvuhetazhnye"),
        ]),
  ...
  <p class="sub">Мы сами контролируем основные процессы строительства, работаем
  большими объёмами и не переплачиваем посредникам. Поэтому можем держать
  доступную цену без лишних наценок.</p>
  %s""" % grid(2, [
        card("Свой пиломатериал",
             "Используем собственный пиломатериал и контролируем его "
             "качество на всех этапах строительства."),
        card("Собственное производство комплектующих",
             "Сами изготавливаем необходимые металлические элементы для "
             "строительства и не зависим от сторонних производителей."),
        card("Большой объём строительства",
             "В сезон сдаём до 10 домов в месяц. Большие объёмы позволяют "
             "выгоднее закупать материалы и эффективно организовывать "
             "работу."),
        card("Опытные бригады",
             "Постоянные бригады давно работают с нами и хорошо знают "
             "технологию строительства каркасных домов."),
        card("Собственная доставка",
             "Доставляем материалы на участок собственным грузовым "
             "транспортом и не переплачиваем сторонним перевозчикам."),
        card("Без лишних наценок",
             "Не закладываем в стоимость искусственные скидки и акции. "
             "Поэтому сразу называем реальную цену строительства."),
    ]),
        "Такого блока почти нет у конкурентов. Он снимает недоверие "
        "«слишком дёшево, значит подвох». Текст блока полностью прислал клиент."))
  ...
  в эти же сроки.</p>""" % (
        table(["Размер дома", "Площадь", "Срок строительства"], [
            ...
            ["4&times;6, 5&times;6", "24&ndash;30 м&sup2;", "Неделя"],
            ["6&times;6, 6&times;8", "36&ndash;48 м&sup2;", "15 дней"],
  ...
  %s""" % (
        steps([
            ...
            ("Строительство на участке",
             ...
             "строительство."),
            ("Приёмка дома",
             "Осматриваете готовый дом и получаете ключи от своего дома."),
        ])),
    ...
    b.append(sec("Ваши гарантии и защита", """
  <h2>Ваши гарантии и защита</h2>
  <p class="sub">До начала строительства вы знаете, за что платите, какие работы
  входят в стоимость и какие обязательства берём на себя.</p>
  %s""" % grid(3, [
        card("Всё закрепляем в договоре",
             "Стоимость, состав работ, сроки и ответственность сторон "
             "фиксируем до начала строительства."),
        card("Гарантия 3&ndash;5 лет",
             "3 года для дачных домов и 5 лет для домов постоянного "
             "проживания. Прописана в договоре."),
        card("Договор заключаем официально",
             "Работаем как ИП и заранее фиксируем в договоре стоимость, "
             "состав работ и основные условия строительства."),
        card("Приёмка по акту",
             "Перед подписанием акта осматриваете готовый дом. Если есть "
             "замечания, устраняем их и повторно показываем результат."),
        card("Материалы под нашей ответственностью",
             "До передачи готового дома мы отвечаем за сохранность "
             "материалов на участке."),
  ...
  %s""" % grid(2, [
        ...
        card("Из чего строите дома?",
             "Из пиломатериала &mdash; каркасная технология. Материал свой, "
             "работаем своими бригадами: без посредников и подрядчиков."),
        ...
        card("Какую гарантию вы даёте на дом?",
             "3 года для дачных домов и 5 лет для домов постоянного "
             "проживания. Гарантия прописывается в договоре."),
    ]),
...
def page_catalog():
  ...
  <aside class="filters">
    ...
    <div class="fg desk">
      ...
      <label class="fopt">Двухэтажный</label>
    </div>
    <div class="fg desk">
