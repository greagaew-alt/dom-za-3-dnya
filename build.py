...
def page_index():
  ...
  <div class="quiz">
    <div class="qstep"><div class="qnum">Шаг 1 из 5</div>
      ...
      <span class="opt">Зимняя дача &mdash; можно приезжать на выходных</span>
  ...
  <p class="sub">Мы контролируем весь процесс сами: от производства материалов
  до сдачи ключей. Поэтому можем держать доступную цену без лишних наценок.</p>
  %s""" % grid(2, [
        card("Свои материалы и производство",
             "У нас свой пиломатериал и собственное производство "
             "металлических изделий &mdash; сами гнём металл. Не покупаем "
             "у посредников, а производим сами."),
        card("Не платим посредникам",
             "Все основные процессы контролируем внутри компании &mdash; "
             "включая доставку: свой грузовой транспорт."),
        card("Большой объём строительства",
             "В месяц сдаём по 10 домов. Сезон у нас с апреля по сентябрь "
             "&mdash; за это время строим гораздо больше, чем разовый заказ."),
        card("Отточенная технология",
             "Строим типовые одноэтажные и полутораэтажные дома. Бригады "
             "работают с нами много лет &mdash; технология отточена "
             "до мелочей."),
        card("Цена без накруток",
             "Не закладываем в стоимость скидки и акции, которые потом "
             "приходится отбивать. Поэтому цена сразу ниже, чем у других."),
    ]),
